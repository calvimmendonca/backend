...
const selectFields = {
  ...
  dec_alqissemp:           true,
  dec_alqpisemp:           true,
  dec_alqcrbfnmsegsocemp:  true,
  dec_alqimprndemp:        true,
  dec_alqcrbsocemp:        true,
  dec_alqinunacsegsocemp:  true,
  dec_alqsmpnacemp:        true,
  vch_insmncemp:           true,
  int_codrgmtbtemp:        true,
  // Sintegra / NF
  chr_codopeemp:              true,
  chr_modnotfscemp:           true,
  vch_sernotfscemp:           true,
  tin_codidtettarqmgnemp:     true,
  tin_codidtnatopeemp:        true,
  tin_codfniaprarqmgnemp:     true,
  // Relações
